...
y = decimate(y0(3:end), 8);
v_h = phase_locked_loop(y, 100, 10, 0); %original
...
title('imaginary')
subplot(3, 1, 3)
plot(linspace(-137.9e6/2, 137.9e6/2, length(y)), fftshift(abs(fft(y)))/length(y))
title('fft of y')
figure
